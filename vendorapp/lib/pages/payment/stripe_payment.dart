...
void main() {
  runApp(new StripeApp());
}

class StripeApp extends StatefulWidget {
  @override
  _StripeAppState createState() => new _StripeAppState();
}

class _StripeAppState extends State<StripeApp> {
  Token _paymentToken;
